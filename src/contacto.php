...
Class Contacto extends Conexion{
	 ...
	 public function verificaridadminid($id) {
        $this->sentencia = "SELECT * FROM administrador WHERE id = '$id';";
        return $this->obtener_sentencia();
    }
    
    public function consultarmaestroid($id) {
        $this->sentencia = "SELECT * FROM maestro WHERE id = '$id';";
        return $this->obtener_sentencia();
    }
    
    public function consultaralumnoid($id) {
